...
public class PermisoService implements PermisoRepository {
    ...
    @Override
    public Permiso getReferenceById(Long id) {
        // TODO Auto-generated method stub
    ...
    @Override
    public <S extends Permiso, R> R findBy(Example<S> example, Function<FetchableFluentQuery<S>, R> queryFunction) {
        // TODO Auto-generated method stub
